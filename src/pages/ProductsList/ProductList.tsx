...
type Product = {
    ...
    category: FilterType;
    size?: SizeType;
    slug: string; // used when category === "SIZE"
};
...
export default function ProductsPage() {
    ...
    const productData: Record<CategoryType, Array<Product>> = {
        Clothes: [
            ...
            { id: 5, slug: "5", name: "DENIM JACKET", price: "129DT", image: "https://api.builder.io/api/v1/image/assets/TEMP/245e0cc00bf0dc89fe40b6c9f6d4b3cdc6311ea3?width=652", category: "NEWEST" },
        ...
        Women: [
            ...
            { id: 21, slug: "21", name: "MIDI DRESS", price: "149 DT", image: "https://api.builder.io/api/v1/image/assets/TEMP/245e0cc00bf0dc89fe40b6c9f6d4b3cdc6311ea3?width=652", category: "NEWEST" },
            { id: 23, slug: "23", name: "CASHMERE SCARF", price: "89 DT", image: "https://api.builder.io/api/v1/image/assets/TEMP/245e0cc00bf0dc89fe40b6c9f6d4b3cdc6311ea3?width=652", category: "FEATURED" },
            { id: 24, slug: "24", name: "HIGH HEELS", price: "179 DT", image: "https://api.builder.io/api/v1/image/assets/TEMP/245e0cc00bf0dc89fe40b6c9f6d4b3cdc6311ea3?width=652", category: "SIZE", size: "SMALL" },
            { id: 25, slug: "25", name: "LEATHER HANDBAG", price: "249 DT", image: "https://api.builder.io/api/v1/image/assets/TEMP/245e0cc00bf0dc89fe40b6c9f6d4b3cdc6311ea3?width=652", category: "SIZE", size: "LARGE" },
        ],
    };
                    ...
                    >
                        <ProductCard
                            ...
                            onAddToBag={() => {
                                ...
                                // optional: open slide-over after add
                            }}
                        />
                    </div>
                ))}
